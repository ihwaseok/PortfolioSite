...
<svg
   ...
   sodipodi:docname="joplin-logo.svg"
   version="1.1"
   id="svg2"
   xml:space="preserve"
   width="25"
   height="22"
   viewBox="0 0 682.66669 682.66669"><title
   id="title842">Joplin Icon</title><metadata
   id="metadata15"><rdf:RDF><cc:Work
       rdf:about=""><dc:format>image/svg+xml</dc:format><dc:type
         rdf:resource="http://purl.org/dc/dcmitype/StillImage" /><dc:title>Joplin Icon</dc:title><cc:license
         rdf:resource="MIT -- https://github.com/laurent22/joplin/blob/master/LICENSE" /><dc:creator><cc:Agent><dc:title>Laurent Cozic</dc:title></cc:Agent></dc:creator></cc:Work></rdf:RDF></metadata><sodipodi:namedview
